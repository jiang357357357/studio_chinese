...
export const Projects = observer(
    class Projects extends React.Component {
        onContextMenu = (node: IListNode<IMruItem>) => {
            ...
            menu.append(
                new MenuItem({
                    label: t("Edit Project", "Edit Project"),
            ...
            if (node.data.hasFlowSupport) {
                menu.append(
                    new MenuItem({
                        label: t("Run Project", "Run Project"),
            ...
            menu.append(
                new MenuItem({
                    label: t("Copy Project Path", "Copy Project Path"),
            ...
            menu.append(
                new MenuItem({
                    label: t("Remove From List", "Remove From List"),
                ...
                <div className="EezStudio_HomeTab_Projects">
                    <div className="EezStudio_HomeTab_Projects_Header">
                        ...
                        <IconAction
                            ...
                            title={
                                openProjectsStore.sortAlphabetically
                                    ? t("Sort alphabetically", "Sort alphabetically")
                                    : t("Show most recent first", "Show most recent first")
                            }
                    ...
                    <div className="EezStudio_HomeTab_Projects_Body">
                        ...
                        <div className="EezStudio_HomeTab_Projects_Actions">
                            <ButtonAction
                                ...
                                text={t("Open Project", "Open Project")}
                                title={t("Open a local EEZ Studio Project", "Open a local EEZ Studio Project")}
                ...
                <div className="EezStudio_HomeTab_Projects_ProjectInfo">
                    {openProjectsStore.selectedProjectInfo && (
                        <div className="EezStudio_HomeTab_Projects_ProjectInfo_Actions">
                            <ButtonAction
                                className="btn-primary"
                                text={t("Edit Project", "Edit Project")}
                                title={t("Edit Project", "Edit Project")}
                                icon="material:edit"
                            ...
                            {openProjectsStore.selectedProjectInfo
                                .hasFlowSupport && (
                                    <ButtonAction
                                        ...
                                        text={t("Run Project", "Run Project")}
                                        title={t("Run Project", "Run Project")}
                            ...
                            <ButtonAction
                                className="btn-secondary"
                                text={t("Copy Project Path", "Copy Project Path")}
                                title={t("Copy Project Path", "Copy Project Path")}
                                icon="material:content_copy"
                                onClick={openProjectsStore.copyProjectPath}
                            />
                            <ButtonAction
                                className="btn-danger"
                                text={t("Remove From List", "Remove From List")}
                                title={t("Remove From List", "Remove From List")}
                                icon="material:close"
