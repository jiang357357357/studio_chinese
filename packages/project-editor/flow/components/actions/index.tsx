...
class SwitchTest extends EezObject {
    ...
    static classInfo: ClassInfo = {
        ...
        listLabel: (test: SwitchTest, collapsed) =>
            !collapsed
                ? ""
                : `WHEN ${test.condition} THEN OUTPUT ${test.outputName}${test.outputValue ? ` WITH VALUE ${test.outputValue}` : ""
                }`,
...
export class SortArrayActionComponent extends ActionComponent {
    ...
    static classInfo = makeDerivedClassInfo(ActionComponent.classInfo, {
        ...
        componentPaletteLabel: "SortArray",
        componentPaletteGroupName: "!3Common Actions",
        properties: [
            makeExpressionProperty(
                {
                    name: "array",
            ...
            {
                name: "ascending",
                displayName: t("Ascending", "Ascending"),
            ...
            {
                name: "ignoreCase",
                displayName: t("Ignore case", "Ignore case"),
                type: PropertyType.Boolean,
                checkboxStyleSwitch: true,
                propertyGridGroup: specificGroup
            }
        ...
        return (
            <>
                <div className="title-enclosure">
                    ...
                    >
                        <polygon
                            points={`0.5,${this.height / 2} ${this.height / 2
                                },0.5 ${this.width - 0.5},0.5 ${this.width - 0.5},${this.height - 0.5
        ...
        return (
            <>
                <div className="title-enclosure">
                    ...
                    >
                        <polygon
                            points={`0.5,0.5 ${this.width - 0.5 - this.height / 2
                                },0.5 ${this.width - 0.5},${this.height / 2} ${this.width - 0.5 - this.height / 2
