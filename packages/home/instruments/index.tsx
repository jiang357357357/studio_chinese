...
export class InstrumentsStore {
    ...
    createContextMenu(instrument: InstrumentObject) {
        ...
        if (instrument.isUnknownExtension) {
            ...
            menu.append(
                new MenuItem({
                    label: t("Install Extension", "Install Extension"),
                    click: () => {
        ...
        menu.append(
            new MenuItem({
                label: t("Open in Tab", "Open in Tab"),
                click: () => {
        ...
        menu.append(
            new MenuItem({
                label: t("Open in New Window", "Open in New Window"),
                click: () => {
        ...
        <button
            ...
            title={
                tab.instance.tooltipTitle
                    ? tab.instance.tooltipTitle
                    : `${t("Show", "Show")} ${tab.instance.title} ${t("Tab", "Tab")}`
            }
        ...
        render() {
            let buttons: {
                ...
                enabled?: boolean;
            }[] = [
                    {
                        ...
                        title: t("Add instrument", "Add instrument"),
            ...
            if (deletedInstruments.size > 0) {
                buttons.push({
                    ...
                    label: t("Deleted Instruments", "Deleted Instruments"),
                    title: t("Show deleted instruments", "Show deleted instruments"),
            ...
            buttons.push({
                ...
                title: t("Export to database", "Export to database"),
                className: "btn-secondary",
                onClick: () => {
            ...
            buttons.push({
                ...
                title: t("Import from database", "Import from database"),
                className: "btn-secondary",
                onClick: async () => {
