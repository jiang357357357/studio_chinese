...
export class ProjectEditorTab implements IHomeTab {
    ...
    get titleStr() {
        ...
        if (this.filePath) {
            ...
            return (
                path.basename(this.filePath, ".eez-dashboard") + " " + t("dashboard", "dashboard")
            );
        }

        return t("Untitled project", "Untitled project");
    }
    ...
    constructor() {
        ...
        loadPreinstalledExtension("instrument").then(async () => {
            ...
            autorun(() => {
                ...
                if (this.activeTab) {
                    title = `${this.activeTab.modified ? MODIFED_MARK : ""}${this.activeTab.titleStr
                        } - EEZ Studio`;
                } else {
                    title = `EEZ Studio`;
                }
