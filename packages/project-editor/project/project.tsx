    ...
    static classInfo: ClassInfo = {
        ...
        properties: [
            ...
            },
            {
                ...
                displayName: t("Destination folder", "Destination folder"),
                type: PropertyType.RelativeFolder
            },
            {
                name: "separateFolderForImagesAndFonts",
                displayName: t("Store image and font files in a separate folder", "Store image and font files in a separate folder"),
            ...
            },
            {
                ...
                displayName: t("Image export mode", "Image export mode"),
                type: PropertyType.Enum,
                enumItems: [
                    {
                        id: "source",
            ...
            {
                name: "fontExportMode",
                displayName: t("Font export mode", "Font export mode"),
                type: PropertyType.Enum,
                enumItems: [
                    {
                        id: "source",
            ...
            {
                name: "lvglInclude",
                displayName: t("LVGL include", "LVGL include"),
                type: PropertyType.String,
                disabled: isNotLVGLProject
            },
            {
                name: "screensLifetimeSupport",
                displayName: t("Screens lifetime support", "Screens lifetime support"),
                checkboxStyleSwitch: true,
                type: PropertyType.Boolean,
                disabled: isNotLVGLProject
            },
            {
                ...
                displayName: t("Generate source code for EEZ Flow engine (eez-framework)", "Generate source code for EEZ Flow engine (eez-framework)"),
                type: PropertyType.Boolean,
                checkboxStyleSwitch: true,
                disabled: object =>
                    isNotLVGLProject(object) ||
            ...
            },
            {
                ...
                displayName: t("Compress flow definition", "Compress flow definition"),
                type: PropertyType.Boolean,
                checkboxStyleSwitch: true,
                disabled: (object: Build) =>
                    isNotLVGLProject(object) ||
            ...
            },
            {
                ...
                displayName: t("Execution queue size", "Execution queue size"),
            ...
            },
            {
                ...
                displayName: t("Expression evaluator stack size", "Expression evaluator stack size"),
                type: PropertyType.Number,
                disabled: (object: Build) =>
                    isNotLVGLProject(object) ||
                    !getProject(object).projectTypeTraits.hasFlowSupport ||
...
export const PROJECT_TYPE_NAMES = {
    [ProjectType.UNDEFINED]: t("Undefined", "Undefined"),
    [ProjectType.FIRMWARE]: t("EEZ-GUI", "EEZ-GUI"),
    [ProjectType.FIRMWARE_MODULE]: t("EEZ-GUI Library", "EEZ-GUI Library"),
    [ProjectType.RESOURCE]: t("BB3 MicroPython Script", "BB3 MicroPython Script"),
    [ProjectType.APPLET]: t("BB3 Applet", "BB3 Applet"),
    [ProjectType.DASHBOARD]: t("Dashboard", "Dashboard"),
    [ProjectType.LVGL]: t("LVGL", "LVGL"),
    [ProjectType.IEXT]: t("IEXT", "IEXT")
};
...
export class General extends EezObject {
    ...
    static classInfo: ClassInfo = {
        ...
        properties: [
            {
                name: "projectType",
                displayName: t("Project type", "Project type"),
                type: PropertyType.Enum,
                enumItems: [
                    {
            ...
            },
            {
                ...
                displayName: (object: General) => {
                    if (object.projectType == ProjectType.RESOURCE) {
                        return t("Target BB3 firmware", "Target BB3 firmware");
                    }
                    return t("Project version", "Project version");
                },
                type: PropertyType.Enum,
                enumItems: (object: General) => {
                    if (object.projectType == ProjectType.RESOURCE) {
                        return [
                            { id: "v2", label: t("1.7.X or older", "1.7.X or older") },
                            { id: "v3", label: t("1.8 or newer", "1.8 or newer") }
                        ];
                    } else {
            ...
            },
            {
                ...
                type: PropertyType.Enum,
                enumItems: [
                    { id: "SCPI", label: t("SCPI", "SCPI") },
                    { id: "PROPRIETARY", label: t("Proprietary", "Proprietary") }
                ],
                enumDisallowUndefined: true,
            ...
            {
                name: "lvglVersion",
                displayName: t("LVGL version", "LVGL version"),
                type: PropertyType.Enum,
                enumItems: [
                    { id: "8.3", label: "8.x" },
                    { id: "9.0", label: "9.x" }
            ...
            },
            {
                ...
                displayName: (object: General) =>
                    getProject(object).scpi
                        ? t("SCPI documentation folder", "SCPI documentation folder")
                        : t("Commands documentation folder", "Commands documentation folder"),
                type: PropertyType.RelativeFolder,
            ...
            },
            {
                ...
                type: PropertyType.RelativeFile,
                fileFilters: [
                    { name: t("EEZ Project", "EEZ Project"), extensions: ["eez-project"] },
            ...
            {
                name: "extensions",
                displayName: t("Extensions", "Extensions"),
                type: PropertyType.Array,
            ...
            */
            {
                name: "displayWidth",
                displayName: t("Display width", "Display width"),
                type: PropertyType.Number,
                disabled: (general: General) =>
            ...
            {
                name: "displayHeight",
                displayName: t("Display height", "Display height"),
                type: PropertyType.Number,
                disabled: (general: General) =>
                    !ProjectEditor.getProject(general).projectTypeTraits
                        .hasDisplaySizeProperty
            },
            {
                ...
                displayName: t("Circular display", "Circular display"),
                type: PropertyType.Boolean,
                checkboxStyleSwitch: true,
                disabled: isNotLVGLProject
            },
            {
                ...
                displayName: t("Display border radius", "Display border radius"),
                type: PropertyType.Number,
                disabled: (general: General) =>
            ...
            {
                name: "darkTheme",
                displayName: t("Dark theme", "Dark theme"),
                type: PropertyType.Boolean,
                checkboxStyleSwitch: true,
                disabled: isNotLVGLProject
            },
            {
                name: "colorFormat",
                displayName: t("Color format", "Color format"),
                type: PropertyType.Enum,
                enumItems: [
                    { id: "RGB", label: "RGB" },
                    { id: "BGR", label: "BGR" }
            ...
            {
                name: "flowSupport",
                displayName: t("Flow support", "Flow support"),
                type: PropertyType.Boolean,
                checkboxStyleSwitch: true,
                disabled: (general: General) => {
                    return (
            ...
            },
            {
                ...
                displayName: t("Hidden widget lines", "Hidden widget lines"),
                type: PropertyType.Enum,
                enumItems: [
                    { id: "visible", label: t("Fully visible", "Fully visible") },
                    { id: "dimmed", label: t("Dimmed", "Dimmed") },
                    { id: "hidden", label: t("Hidden", "Hidden") }
                ],
                enumDisallowUndefined: true,
                disabled: (general: General) => {
                    return (
            ...
            },
            {
                ...
                displayName: t("Dimmed lines opacity (%)", "Dimmed lines opacity (%)"),
                type: PropertyType.Number,
                disabled: (general: General) => {
                    return (
                        (!general.flowSupport &&
            ...
            {
                name: "keywords",
                displayName: t("Keywords", "Keywords"),
                type: PropertyType.String
            },
            {
                name: "targetPlatform",
                displayName: (general: General) =>
                    general.projectType == ProjectType.IEXT
                        ? t("Target instrument", "Target instrument")
            ...
            },
            {
                ...
                displayName: (general: General) =>
                    general.projectType == ProjectType.IEXT
                        ? t("Target instrument link", "Target instrument link")
                        : t("Target platform link", "Target platform link"),
                type: PropertyType.String
            },
            {
                name: "author",
                displayName: t("Author", "Author"),
                type: PropertyType.String
            },
            {
                name: "authorLink",
                displayName: t("Author link", "Author link"),
                type: PropertyType.String
            },
            {
                name: "minStudioVersion",
                displayName: t("Min. studio version", "Min. studio version"),
                type: PropertyType.String
            },
            {
                name: "resourceFiles",
                displayName: t("Resource files", "Resource files"),
                type: PropertyType.Array,
