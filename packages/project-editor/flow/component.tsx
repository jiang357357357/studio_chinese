                    ...
                    ? (props: PropertyProps) => {
                        ...
                        if (props.objects.length == 1) {
                            ...
                            if (
                                ...
                                menuItems.push(
                                    new MenuItem({
                                        label: t("Convert to input", "Convert to input"),
                                        click: () => {
                                            const projectStore =
                                                getProjectStore(
                                                    props.objects[0]
    ...
    if (projectStore.projectTypeTraits.hasFlowSupport) {
        if (uiStateStore?.isBreakpointAddedForComponent(component)) {
            additionalMenuItems.push(
                new MenuItem({
                    label: t("Remove Breakpoint", "Remove Breakpoint"),
            ...
            if (uiStateStore.isBreakpointEnabledForComponent(component)) {
                additionalMenuItems.push(
                    new MenuItem({
                        label: t("Disable Breakpoint", "Disable Breakpoint"),
                ...
                additionalMenuItems.push(
                    new MenuItem({
                        label: t("Enable Breakpoint", "Enable Breakpoint"),
            ...
            additionalMenuItems.push(
                new MenuItem({
                    label: t("Add Breakpoint", "Add Breakpoint"),
            ...
            component.inputs.forEach(componentInput => {
                ...
                if (
                    ...
                    messages.push(
                        new Message(
                            MessageType.ERROR,
                            `No connection to input "${componentInput.displayName ||
                            componentInput.name
                            }"`,
                            component,
                            undefined,
            ...
            component.outputs.forEach(componentOutput => {
                ...
                if (
                    ...
                    messages.push(
                        new Message(
                            MessageType.ERROR,
                            `Output "${componentOutput.displayName
        ...
        extendContextMenu: (
            ...
            if (!project.projectTypeTraits.isLVGL) {
                if (objects.length === 1) {
                    additionalMenuItems.push(
                        new MenuItem({
                            label: t("Put in Select", "Put in Select"),
                            click: () => {
                                const selectWidget = (
                                    objects[0] as Widget
                                ).putInSelect();
                ...
                if (areAllChildrenOfTheSameParent(objects)) {
                    additionalMenuItems.push(
                        new MenuItem({
                            label: t("Put in Container", "Put in Container"),
                            click: () => {
                    ...
                    additionalMenuItems.push(
                        new MenuItem({
                            label: t("Put in List", "Put in List"),
                            click: () => {
                    ...
                    additionalMenuItems.push(
                        new MenuItem({
                            label: t("Create User Widget", "Create User Widget"),
                            click: async () => {
                                const layoutWidget =
                    ...
                    additionalMenuItems.push(
                        new MenuItem({
                            label: t("Replace with User Widget", "Replace with User Widget"),
                            click: async () => {
                                const layoutWidget =
                ...
                if (objects.length === 1) {
                    additionalMenuItems.push(
                        new MenuItem({
                            label: t("Resize...", "Resize..."),
                            click: async () => {
                                const widget = objects[0] as Widget;

                                const result = await showGenericDialog({
                                    dialogDefinition: {
                                        title: t("Resize Widget", "Resize Widget"),
                                        fields: [
                                            {
                                                name: "width",
                                                type: "number"
            ...
            if (additionalMenuItems.length > 0) {
                ...
                additionalMenuItems.push(
                    new MenuItem({
                        label: t("Copy position and size", "Copy position and size"),
                        click: async () => {
                ...
                additionalMenuItems.push(
                    new MenuItem({
                        label: t("Paste position and size", "Paste position and size"),
                        click: async () => {
                            if (positionAndSize) {
                ...
                if (
                    ...
                    if (object.left < 0) {
                        messages.push(
                            new Message(
                                MessageType.WARNING,
                                t("Widget is outside of its parent", "Widget is outside of its parent"),
