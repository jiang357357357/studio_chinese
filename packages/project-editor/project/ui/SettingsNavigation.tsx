...
const ProjectFeature = observer(
    ...
    > {
        ...
        onRemove = () => {
            confirm(
                t("Are you sure you want to remove this feature?", "Are you sure you want to remove this feature?"),
                undefined,
                () => {
            ...
            if (
                ...
                if (mandatory) {
                    button = (
                        <button
                            ...
                            disabled={true}
                            title={t("This feature can't be removed", "This feature can't be removed")}
                        >
                            {t("Remove", "Remove")}
                        </button>
                    );
                    ...
                    button = (
                        <button
                            ...
                            title={t("Remove feature from the project", "Remove feature from the project")}
                        >
                            {t("Remove", "Remove")}
                        </button>
                    );
                ...
                button = (
                    <button
                        ...
                        onClick={this.onAdd}
                        title={t("Add feature to the project", "Add feature to the project")}
                    >
                        {t("Add", "Add")}
                    </button>
                );
            ...
            if (this.object === this.context.project.settings.general) {
                ...
                return (
                    <div className="EezStudio_SettingsEditor">
                        ...
                        <h3>{t("Project features", "Project features")}</h3>
...
const AddButton = observer(
    class AddButton extends React.Component<{
        ...
        render() {
            const selected = this.props.objectAdapter.selectedObject;
            const canAddItem = selected && canAdd(selected);

            if (!canAddItem) {
                return null;
            }

            const name = getAddItemName(selected!) ?? t("Item", "Item");
            const title = t("Add", "Add") + " " + t(name, name) + "...";
...
const DeleteButton = observer(
    class DeleteButton extends React.Component<{
        ...
        render() {
            return (
                <IconAction
                    title={t("Delete Selected Item", "Delete Selected Item")}
