        ...
        render() {
            ...
            if (this.context.project.settings.general.commandsDocFolder) {
                additionalButtons = [
                    <IconAction
                        key="refresh"
                        title={t("Refresh with content from commands help folder", "Refresh with content from commands help folder")}
    ...
    class InstrumentCommandHelpPreview extends EditorComponent {
        ...
        render() {
            ...
            if (
                ...
                return <div>{t("No help page defined!", "No help page defined!")}</div>;
            }
        }
    }
);
