...
registerActionComponents("Python", [
    {
        ...
        properties: [
            {
                ...
                enumItems: [
                    {
                        id: "inline-script",
                        label: t("Inline script", "Inline script")
                    },
                    {
                        id: "inline-script-as-expression",
                        label: t("Inline script as expression", "Inline script as expression")
                    },
                    {
                        id: "script-file",
            ...
            },
            {
                ...
                displayName: t("Inline script", "Inline script"),
                type: "inline-code",
                language: "Python",
            ...
            },
            {
                ...
                displayName: t("Inline script as expression", "Inline script as expression"),
                type: "expression",
                valueType: "string",
                disabled: (...props: string[]) => {
            ...
            },
            {
                ...
                displayName: t("Script file", "Script file"),
                type: "expression",
                valueType: "string",
                disabled: (...props: string[]) => {
        ...
        execute: (context: IDashboardComponentContext) => {
            ...
            if (scriptSource == undefined) {
                context.throwError(t("Invalid script source", "Invalid script source"));
                return;
            }
    ...
    },
    {
        ...
        execute: (context: IDashboardComponentContext) => {
            ...
            if (!handle) {
                context.throwError(t("Handle not defined", "Handle not defined"));
                return;
            }
            const { pythonShell } = getPythonShell(handle);
            if (!pythonShell) {
                context.throwError(t("Invalid handle", "Invalid handle") + " " + handle);
                return;
            }

            const message = context.evalProperty<string>("message");
            if (!message) {
                context.throwError(t("Message not defined", "Message not defined"));
                return;
            }
