        ...
        render() {
            const buttons = [
                <IconAction
                    ...
                    title={
                        this.allBreakpointsEnabled
                            ? t("Disable all breakpoints", "Disable all breakpoints")
                            : t("Enable all breakpoints", "Enable all breakpoints")
                    }
                ...
                <IconAction
                    ...
                    iconSize={16}
                    title={t("Remove selected breakpoint", "Remove selected breakpoint")}
                ...
                <IconAction
                    ...
                    iconSize={16}
                    title={t("Remove all breakpoints", "Remove all breakpoints")}
            ...
            return (
                <div className="form-check">
                    <input
                        ...
                        title={
                            checked
                                ? t("Disable breakpoint", "Disable breakpoint")
                                : t("Enable breakpoint", "Enable breakpoint")
                        }
                    />
