    ...
    static classInfo: ClassInfo = {
        properties: [
            ...
            },
            {
                ...
                displayName: (bitmap: Bitmap) => t("Binary output format", "Binary output format"),
                type: PropertyType.Enum,
                enumItems: [
                    { id: 0, label: t("RGB332", "RGB332") },
                    { id: 1, label: t("RGB565", "RGB565") },
                    { id: 2, label: t("RGB565 Swap", "RGB565 Swap") },
                    { id: 3, label: t("RGB888", "RGB888") }
                ],
                defaultValue: 3,
                disabled: (bitmap: Bitmap) => {
