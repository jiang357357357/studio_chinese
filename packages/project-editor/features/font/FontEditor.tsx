        ...
        onAddGlyph() {
            ...
            function fontFileExists(object: any, ruleName: string) {
                ...
                if (
                    ...
                    return t("File not found", "File not found");
                }
            ...
            const addOptionEnumItems = [
                {
                    id: "append",
                    label: t("Add single character at the end", "Add single character at the end")
                },
                {
                    id: "range",
                    label: t("Add characters from range", "Add characters from range")
                }
            ];
            ...
            if (missingEncodings.length > 0) {
                addOptionEnumItems.push({
                    id: "missing",
                    label: t("Add missing characters", "Add missing characters")
                });
            }

            return showGenericDialog(this.context, {
                dialogDefinition: {
                    title: t("Add Characters", "Add Characters"),
                    fields: [
                        {
                            name: "filePath",
                    ...
                    return extractFont({
                        ...
                        .then(font => {
                            ...
                            if (result.values.addOption === "missing") {
                                notification.info(
                                    `Added ${added} character(s), not found ${missingEncodings.length - added
                                    } character(s)`
                                );
                            } else if (result.values.addOption === "range") {
                                notification.info(
