...
export class LayoutModels extends AbstractLayoutModels {
    ...
    static WIDGETS_TAB: FlexLayout.IJsonTabNode = {
        type: "tab",
        enableClose: false,
        name: t("User Widgets", "User Widgets"),
        component: "widgets",
    ...
    static ACTIONS_TAB: FlexLayout.IJsonTabNode = {
        type: "tab",
        enableClose: false,
        name: t("User Actions", "User Actions"),
        component: "actions",
        icon: "material:code",
    ...
    static INSTRUMENT_COMMANDS_TAB: FlexLayout.IJsonTabNode = {
        type: "tab",
        enableClose: false,
        name: t("Instrument Commands", "Instrument Commands"),
    ...
    static BREAKPOINTS_TAB: FlexLayout.IJsonTabNode = {
        type: "tab",
        enableClose: false,
        name: t("Breakpoints", "Breakpoints"),
    ...
    static COMPONENTS_PALETTE_TAB: FlexLayout.IJsonTabNode = {
        type: "tab",
        enableClose: false,
        name: t("Components Palette", "Components Palette"),
                                        ...
                                        children: [
                                            {
                                                type: "tab",
                                                enableClose: false,
                                                name: t("Widgets Structure", "Widgets Structure"),
                                        ...
                                        children: [
                                            {
                                                type: "tab",
                                                enableClose: false,
                                                name: t("Active Flows", "Active Flows"),
                                        ...
                                        children: [
                                            {
                                                type: "tab",
                                                enableClose: false,
                                                name: t("Text resources", "Text resources"),
                                        ...
                                        children: [
                                            {
                                                type: "tab",
                                                enableClose: false,
                                                name: t("Group Widgets", "Group Widgets"),
                                                component: "order"
                                            }
                                        ]
                                    }
