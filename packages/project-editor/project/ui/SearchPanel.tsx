            ...
            return (
                <div className="EezStudio_ToolbarSearch">
                    <IconAction
                        ...
                        title={t("Toggle Replace", "Toggle Replace")}
                        iconSize={20}
                    ...
                    <div className="EezStudio_ToolbarSearch_Sections">
                        <div className="EezStudio_ToolbarSearch_SearchSection">
                            ...
                            <div className="btn-group" role="group">
                                ...
                                <IconAction
                                    ...
                                    title={t("Match Whole Word", "Match Whole Word")}
                                    iconSize={20}
                                    selected={
                                        this.context.uiStateStore
                            ...
                            <div className="btn-group" role="group">
                                <IconAction
                                    title={t("Refresh Search Results", "Refresh Search Results")}
                            ...
                            <div className="btn-group" role="group">
                                <IconAction
                                    title={t("Next Result", "Next Result")}
                                    icon="material:arrow_downward"
                                    onClick={() => this.nextResult()}
                                    enabled={this.nextResultEnabled}
                                />
                                <IconAction
                                    title={t("Previous Result", "Previous Result")}
                        ...
                        {this.context.uiStateStore.replaceEnabled && (
                            <div className="EezStudio_ToolbarSearch_ReplaceSection">
                                ...
                                <div className="btn-group" role="group">
                                    <IconAction
                                        title={t("Replace Selected", "Replace Selected")}
                                    ...
                                    />
                                    <IconAction
                                        title={t("Replace All", "Replace All")}
