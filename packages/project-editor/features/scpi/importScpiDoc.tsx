    ...
    getCommandsFromScpiDoc() {
        return new Promise<Subsystem[]>((resolve, reject) => {
            if (
                ...
                reject(t("SCPI help folder is not defined", "SCPI help folder is not defined"));
                return;
            }
            ...
            fs.exists(scpiHelpFolderPath, (exists: boolean) => {
                if (!exists) {
                    reject(
                        `${t("SCPI help folder", "SCPI help folder")} "${scpiHelpFolderPath}" ${t("doesn't exists.", "doesn't exists.")}`
                    );
                } else {
                    fs.readdir(
                        scpiHelpFolderPath,
                        ...
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="myModalLabel">
                                    {t("Detected SCPI Command Changes", "Detected SCPI Command Changes")}
                                </h5>
                                <button
                                    type="button"
