                    ...
                    <Panel
                        ...
                        title={
                            this.props.runtime.totalMemory != 0
                                ? `${t("Memory usage", "Memory usage")}: ${memAlloc} of ${memTotal} (${Math.round(
                            ...
                            this.props.runtime instanceof DebugInfoRuntime
                                ...
                                : [
                                    ...
                                    <IconAction
                                        ...
                                        iconSize={18}
                                        style={{ marginTop: 4 }}
                                        title={t("Step over (F10)", "Step over (F10)")}
                                        onClick={() => {
                                    ...
                                    <IconAction
                                        ...
                                        iconSize={18}
                                        style={{ marginTop: 4 }}
                                        title={t("Step into (F11)", "Step into (F11)")}
                                        onClick={() => {
                                            this.props.runtime.runSingleStep(
                                                "step-into"
                                            );
                                    ...
                                    <IconAction
                                        ...
                                        iconSize={18}
                                        style={{ marginTop: 4 }}
                                        title={t("Step out (Shift + F11)", "Step out (Shift + F11)")}
                                        onClick={() => {
                                            this.props.runtime.runSingleStep(
                                                "step-out"
                                            );
