                ...
                <div className="EezStudio_ProjectEditor_ToolbarNav_EditorButtons">
                                ...
                                <IconAction
                                    title={
                                        this.context.undoManager.canUndo
                                            ? `${t("Undo", "Undo")} "${this.context.undoManager.undoDescription}"`
                                            : ""
                                    }
                                    icon="material:undo"
                                    onClick={() =>
                                ...
                                <IconAction
                                    title={
                                        this.context.undoManager.canRedo
                                            ? `${t("Redo", "Redo")} "${this.context.undoManager.redoDescription}"`
                                            : ""
                                    }
                                    icon="material:redo"
                                    onClick={() =>
                    ...
                    {this.context.projectTypeTraits.isResource &&
                        this.context.project.micropython && (
                            <div className="btn-group" role="group">
                                <IconAction
                                    title={t("Run MicroPython Script", "Run MicroPython Script")}
                                    icon={RUN_ICON}
                                    iconSize={28}
                                    onClick={() =>
                        ...
                        <>
                            {this.pageTabState && (
                                <>
                                    <div className="btn-group" role="group">
                                        <IconAction
                                            title={t("Show front face", "Show front face")}
                                        ...
                                        />
                                        <IconAction
                                            title={t("Show back face", "Show back face")}
                                    ...
                                    {!this.flowTabState?.flowState && (
                                        <div className="btn-group" role="group">
                                            <IconAction
                                                title={t("Show timeline", "Show timeline")}
                                                icon={
                            ...
                            {(this.flowTabState ||
                                (this.pageTabState &&
                                    ...
                                    <div className="btn-group" role="group">
                                        <IconAction
                                            title={t("Show component descriptions", "Show component descriptions")}
                ...
                >
                    <ul>
                        ...
                        >
                            ...
                            <span style={{ paddingLeft: 2 }}>{t("Global zoom", "Global zoom")}</span>
                        </li>
                    </ul>
                </div>,
                document.body
        ...
        render() {
            ...
            return (
                <div className="EezStudio_ProjectEditor_ToolbarNav_RunEditSwitchControls">
                    <ButtonAction
                        text={t("Edit", "Edit")}
                        title={t("Enter edit mode (Shift+F5)", "Enter edit mode (Shift+F5)")}
                    ...
                    <ButtonAction
                        text={t("Run", "Run")}
                        title={t("Enter run mode (F5)", "Enter run mode (F5)")}
                        icon={RUN_ICON}
                        iconSize={iconSize}
                    ...
                    <ButtonAction
                        text={t("Debug", "Debug")}
                        title={t("Enter debug mode (Ctrl+F5)", "Enter debug mode (Ctrl+F5)")}
                        icon={
