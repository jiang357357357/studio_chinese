                    ...
                    <Dialog
                        ...
                        title={
                            this.props.type == "actions"
                                ? t("Add Action", "Add Action")
                                : t("Add Widget", "Add Widget")
                        }
    ...
    class ComponentsPalette extends React.Component {
        ...
        get items(): SubNavigationItem[] {
            return [
                {
                    name: t(
                        NavigationStore.COMPONENTS_PALETTE_SUB_NAVIGATION_ITEM_WIDGETS,
                        NavigationStore.COMPONENTS_PALETTE_SUB_NAVIGATION_ITEM_WIDGETS
                    ),
                ...
                {
                    name: t(
                        NavigationStore.COMPONENTS_PALETTE_SUB_NAVIGATION_ITEM_ACTIONS,
                        NavigationStore.COMPONENTS_PALETTE_SUB_NAVIGATION_ITEM_ACTIONS
                    ),
