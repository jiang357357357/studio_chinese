    ...
    createContextMenu(
        ...
        if (isPage && objects.length == 0) {
            additionalMenuItems.push(
                new MenuItem({
                    label: t("Center View", "Center View"),
                    click: async () => {
            ...
            additionalMenuItems.push(
                new MenuItem({
                    label: t("Center View on All Pages", "Center View on All Pages"),
                    click: async () => {
                        this.flowContext.viewState.centerView();
            ...
            if (!this.projectStore.uiStateStore.globalFlowZoom) {
                additionalMenuItems.push(
                    new MenuItem({
                        label: t("Set the Same Zoom for All Pages", "Set the Same Zoom for All Pages"),
                        click: async () => {
