        ...
        properties: [
            ...
            },
            {
                ...
                enumItems: [
                    {
                        id: "freetype",
                        label: t("FreeType", "FreeType")
                    },
                    {
                        id: "opentype",
                        label: t("OpenType", "OpenType")
                    }
                ],
                        ...
                        result = await showGenericDialog(projectStore, {
                            dialogDefinition: {
                                ...
                                fields: [
                                    ...
                                    {
                                        name: "filePath",
                                        displayName: t("Font file", "Font file"),
                                    ...
                                    {
                                        name: "bpp",
                                        displayName: t("Bits per pixel", "Bits per pixel"),
                                        type: "enum",
                                        enumItems: [1, 2, 4, 8]
                                    },
                                    {
                                        name: "size",
                                        displayName: t("Font size (pixels)", "Font size (pixels)"),
                                        type: "number"
                                    },
                                    {
                                        name: "ranges",
                                        displayName: t("Ranges", "Ranges"),
                                        type: "string",
                                        validators: [
                                            validateRanges,
                                        ...
                                        formText:
                                            t("Ranges and/or characters to include. Example: 32-127,140,160-170,200,210-255", "Ranges and/or characters to include. Example: 32-127,140,160-170,200,210-255")
                                    },
                                    {
                                        name: "symbols",
                                        displayName: t("Symbols", "Symbols"),
                                        type: "string",
                                        validators: [requiredRangesOrSymbols],
                                        formText:
                                            t("List of characters to include. Example: abc01234äöüčćšđ", "List of characters to include. Example: abc01234äöüčćšđ")
                                    }
                                ]
                            },
                            values
                        ...
                        result = await showGenericDialog(projectStore, {
                            dialogDefinition: {
                                ...
                                fields: [
                                    ...
                                    {
                                        name: "renderingEngine",
                                        displayName: t("Rendering engine", "Rendering engine"),
                                        type: "enum",
                                        enumItems: [
                                            {
                                                id: "freetype",
                                    ...
                                    {
                                        name: "size",
                                        displayName: t("Font size (points)", "Font size (points)"),
                                        type: "number"
                                    },
                                    {
                                        name: "threshold",
                                    ...
                                    {
                                        name: "createGlyphs",
                                        displayName: t("Create characters", "Create characters"),
                                        type: "boolean",
