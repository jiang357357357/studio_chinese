        ...
        return new Promise<CommandDefinition[]>((resolve, reject) => {
            if (
                ...
                reject(
                    this.projectStore.project.scpi
                        ? t("SCPI help folder is not defined", "SCPI help folder is not defined")
                        : t("Commands help folder is not defined", "Commands help folder is not defined")
                );
                return;
            }
            ...
            fs.exists(commandsHelpFolderPath, (exists: boolean) => {
                if (!exists) {
                    reject(
                        this.projectStore.project.scpi
                            ? `${t("SCPI help folder", "SCPI help folder")} "${commandsHelpFolderPath}" ${t("doesn't exists.", "doesn't exists.")}`
                            : `${t("Commands help folder", "Commands help folder")} "${commandsHelpFolderPath}" ${t("doesn't exists.", "doesn't exists.")}`
                    );
                } else {
                    fs.readdir(
        ...
        render() {
            ...
            if (this.error) {
                ...
                if (this.hasChanges) {
                    ...
                    content = (
                        <h4 style={{ textAlign: "center" }}>{t("No changes!", "No changes!")}</h4>
                    );
                        ...
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="myModalLabel">
                                    {t("Detected Instrument Command Changes", "Detected Instrument Command Changes")}
                                </h5>
                                <button
                                    type="button"
