            ...
            },
            {
                ...
                onSelect: async (
                    ...
                    const result = await showGenericDialog({
                        dialogDefinition: {
                            title: t("Select one or more type", "Select one or more type"),
                            size: "medium",
                            fields: [
                                {
                                    name: "numeric",
                                ...
                                },
                                {
                                    ...
                                    type: "enum",
                                    enumItems: [
                                        { id: "nr1", label: t("Integer (NR1)", "Integer (NR1)") },
                                        { id: "nr2", label: t("Decimal (NR2)", "Decimal (NR2)") },
                                        { id: "nr3", label: t("Real (NR3)", "Real (NR3)") }
                                    ],
                                    visible: (values: any) => {
