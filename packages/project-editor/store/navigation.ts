...
export class NavigationStore {
    ...
    static VARIABLES_SUB_NAVIGATION_ITEM_GLOBAL = t("Global", "Global");
    static VARIABLES_SUB_NAVIGATION_ITEM_LOCAL = t("Local", "Local");
    static VARIABLES_SUB_NAVIGATION_ITEM_STRUCTS = t("Structs", "Structs");
    static VARIABLES_SUB_NAVIGATION_ITEM_ENUMS = t("Enums", "Enums");

    static FLOW_STRUCTURE_SUB_NAVIGATION_ID =
        "flow-structure-tab/sub-navigation/selected-item";
    static FLOW_STRUCTURE_SUB_NAVIGATION_ITEM_WIDGETS = t("Widgets", "Widgets");
    static FLOW_STRUCTURE_SUB_NAVIGATION_ITEM_ACTIONS = t("Actions", "Actions");

    static COMPONENTS_PALETTE_SUB_NAVIGATION_ID =
        "variables-tab/sub-navigation/selected-item";
    static COMPONENTS_PALETTE_SUB_NAVIGATION_ITEM_WIDGETS = t("Widgets", "Widgets");
    static COMPONENTS_PALETTE_SUB_NAVIGATION_ITEM_ACTIONS = t("Actions", "Actions");
