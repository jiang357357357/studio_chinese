    ...
    class ChangesTab extends React.Component {
            ...
            >
                ...
                <div className="revision-details">
                    {node.data.hash != MEMORY_HASH &&
                        ...
                        ? `${node.data.hash.slice(0, 8)} • ${node.data.author_name
        ...
        onContextMenu = (node: IListNode<Revision>) => {
            ...
            if (
                ...
                menu.append(
                    new MenuItem({
                        label: t("Select for Compare", "Select for Compare"),
                        click: action(() => {
                            this.context.project.changes._state.revisionForCompareHash =
                                node.data.hash;
                        })
                    ...
                    <ToolbarHeader>
                        <Toolbar>
                            ...
                            <IconAction
                                ...
                                title={t("Compare with other project", "Compare with other project")}
                                onClick={this.open}
                            />
                        </Toolbar>
                    </ToolbarHeader>
